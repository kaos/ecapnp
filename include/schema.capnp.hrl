...
schema(schema) ->
  ['c++'(schema),
   #schema_node{ %% 0xa93fc509624c72d9
     name=schema, id=12195682960037147353, src= <<"include/schema.capnp">>,
     kind=file,
     annotations=
     ...
     nodes=
       [#schema_node{ %% 0xe682ab4cf923a417
          name='Node', id=16610026722781537303, src= <<"include/schema.capnp:Node">>,
          ...
          nodes=
            [#schema_node{ %% 0xec1619d4400a0290
               name=annotation, id=17011813041836786320, src= <<"include/schema.capnp:Node.annotation">>,
               kind=#struct{ dsize=5, psize=5, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{type,
             ...
             #schema_node{ %% 0xb18aa5ac7a0d9420
               name=const, id=12793219851699983392, src= <<"include/schema.capnp:Node.const">>,
               kind=#struct{ dsize=5, psize=5, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{type,
             ...
             #schema_node{ %% 0xe82753cff0c2218f
               name=interface, id=16728431493453586831, src= <<"include/schema.capnp:Node.interface">>,
               kind=#struct{ dsize=5, psize=5, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{methods,
             ...
             #schema_node{ %% 0xb54ab3364333f598
               name=enum, id=13063450714778629528, src= <<"include/schema.capnp:Node.enum">>,
               kind=#struct{ dsize=5, psize=5, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{enumerants,
             ...
             #schema_node{ %% 0x9ea0b19b37fb4435
               name=struct, id=11430331134483579957, src= <<"include/schema.capnp:Node.struct">>,
               kind=#struct{ dsize=5, psize=5, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{dataWordCount,
             ...
             #schema_node{ %% 0xdebf55bbfa0fc242
               name='NestedNode', id=16050641862814319170, src= <<"include/schema.capnp:Node.NestedNode">>,
        ...
        #schema_node{ %% 0x9aad50a41f4af45f
          name='Field', id=11145653318641710175, src= <<"include/schema.capnp:Field">>,
          ...
          nodes=
            [#schema_node{ %% 0xbb90d5c287870be6
               name=ordinal, id=13515537513213004774, src= <<"include/schema.capnp:Field.ordinal">>,
               kind=#struct{ dsize=3, psize=4, esize=inlineComposite,
             ...
             #schema_node{ %% 0xcafccddb68db1d11
               name=group, id=14626792032033250577, src= <<"include/schema.capnp:Field.group">>,
               kind=#struct{ dsize=3, psize=4, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{typeId,
             ...
             #schema_node{ %% 0xc42305476bb4746f
               name=slot, id=14133145859926553711, src= <<"include/schema.capnp:Field.slot">>,
               kind=#struct{ dsize=3, psize=4, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{offset,
        ...
        #schema_node{ %% 0x978a7cebdc549a4d
          name='Enumerant', id=10919677598968879693, src= <<"include/schema.capnp:Enumerant">>,
        ...
        #schema_node{ %% 0x9500cce23b334d80
          name='Method', id=10736806783679155584, src= <<"include/schema.capnp:Method">>,
        ...
        #schema_node{ %% 0xd07378ede1f9cc60
          name='Type', id=15020482145304562784, src= <<"include/schema.capnp:Type">>,
          ...
          nodes=
            [#schema_node{ %% 0xed8bca69f7fb0cbf
               name=interface, id=17116997365232503999, src= <<"include/schema.capnp:Type.interface">>,
               kind=#struct{ dsize=2, psize=1, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{typeId,
             ...
             #schema_node{ %% 0xac3a6f60ef4cc6d3
               name=struct, id=12410354185295152851, src= <<"include/schema.capnp:Type.struct">>,
               kind=#struct{ dsize=2, psize=1, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{typeId,
             ...
             #schema_node{ %% 0x9e0e78711a7f87a9
               name=enum, id=11389172934837766057, src= <<"include/schema.capnp:Type.enum">>,
               kind=#struct{ dsize=2, psize=1, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{typeId,
             ...
             #schema_node{ %% 0x87e739250a60ea97
               name=list, id=9792858745991129751, src= <<"include/schema.capnp:Type.list">>,
               kind=#struct{ dsize=2, psize=1, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{elementType,
        ...
        #schema_node{ %% 0xce23dcd2d7b00c9b
          name='Value', id=14853958794117909659, src= <<"include/schema.capnp:Value">>,
          kind=#struct{ dsize=2, psize=1, esize=inlineComposite,
            union_field=#data{ align=0, default= <<0,0>>, type=
              {union,
                [{0,void,void},
        ...
        #schema_node{ %% 0xf1c8950dab257542
          name='Annotation', id=17422339044421236034, src= <<"include/schema.capnp:Annotation">>,
          kind=#struct{ dsize=1, psize=1, esize=inlineComposite,
            union_field=none,
            fields=
              [{id,
        ...
        #schema_node{ %% 0xd1958f7dba521926
          name='ElementSize', id=15102134695616452902, src= <<"include/schema.capnp:ElementSize">>,
          kind=#enum{ values=
            [{0,empty},
             {1,bit},
             {2,byte},
        ...
        #schema_node{ %% 0xbfc546f6210ad7ce
          name='CodeGeneratorRequest', id=13818529054586492878, src= <<"include/schema.capnp:CodeGeneratorRequest">>,
          ...
          nodes=
            [#schema_node{ %% 0xcfea0eb02e810062
               name='RequestedFile', id=14981803260258615394, src= <<"include/schema.capnp:CodeGeneratorRequest.RequestedFile">>,
               kind=#struct{ dsize=1, psize=2, esize=inlineComposite,
                 union_field=none,
                 fields=
                   [{id,
               ...
               nodes=
                 [#schema_node{ %% 0xae504193122357e5
                    name='Import', id=12560611460656617445, src= <<"include/schema.capnp:CodeGeneratorRequest.RequestedFile.Import">>,
                    kind=#struct{ dsize=1, psize=1, esize=inlineComposite,
                      union_field=none,
                      fields=
                        [{id,
