%% This file was generated 2014-03-28 23:11:53 UTC by ecapnp 0.1.
...
'16610026722781537303'() ->
    #schema_node{name = 'Node', id = 16610026722781537303, src = <<"include/capnp/schema.capnp:Node">>,
		 kind =
...
'16050641862814319170'() ->
    #schema_node{name = 'Node.NestedNode', id = 16050641862814319170,
		 src = <<"include/capnp/schema.capnp:Node.NestedNode">>,
		 kind =
...
'17011813041836786320'() ->
    #schema_node{name = 'Node.annotation', id = 17011813041836786320,
		 src = <<"include/capnp/schema.capnp:Node.annotation">>,
		 kind =
...
'12793219851699983392'() ->
    #schema_node{name = 'Node.const', id = 12793219851699983392,
		 src = <<"include/capnp/schema.capnp:Node.const">>,
		 kind =
		     #struct{dsize = 5, psize = 5, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{name = type,
...
'16728431493453586831'() ->
    #schema_node{name = 'Node.interface', id = 16728431493453586831,
		 src = <<"include/capnp/schema.capnp:Node.interface">>,
		 kind =
		     #struct{dsize = 5, psize = 5, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{name = methods,
...
'13063450714778629528'() ->
    #schema_node{name = 'Node.enum', id = 13063450714778629528,
		 src = <<"include/capnp/schema.capnp:Node.enum">>,
		 kind =
		     #struct{dsize = 5, psize = 5, esize = inlineComposite, union_field = none,
			     fields =
...
'11430331134483579957'() ->
    #schema_node{name = 'Node.struct', id = 11430331134483579957,
		 src = <<"include/capnp/schema.capnp:Node.struct">>,
		 kind =
		     #struct{dsize = 5, psize = 5, esize = inlineComposite, union_field = none,
			     fields =
...
'11145653318641710175'() ->
    #schema_node{name = 'Field', id = 11145653318641710175,
		 src = <<"include/capnp/schema.capnp:Field">>,
		 kind =
...
'10930602151629473554'() ->
    #schema_node{name = 'Field.noDiscriminant', id = 10930602151629473554,
		 src = <<"include/capnp/schema.capnp:Field.noDiscriminant">>,
...
'13515537513213004774'() ->
    #schema_node{name = 'Field.ordinal', id = 13515537513213004774,
		 src = <<"include/capnp/schema.capnp:Field.ordinal">>,
		 kind =
		     #struct{dsize = 3, psize = 4, esize = inlineComposite,
			     union_field =
				 #data{type =
...
'14626792032033250577'() ->
    #schema_node{name = 'Field.group', id = 14626792032033250577,
		 src = <<"include/capnp/schema.capnp:Field.group">>,
		 kind =
...
'14133145859926553711'() ->
    #schema_node{name = 'Field.slot', id = 14133145859926553711,
		 src = <<"include/capnp/schema.capnp:Field.slot">>,
		 kind =
		     #struct{dsize = 3, psize = 4, esize = inlineComposite, union_field = none,
			     fields =
...
'10919677598968879693'() ->
    #schema_node{name = 'Enumerant', id = 10919677598968879693,
		 src = <<"include/capnp/schema.capnp:Enumerant">>,
		 kind =
...
'10736806783679155584'() ->
    #schema_node{name = 'Method', id = 10736806783679155584,
		 src = <<"include/capnp/schema.capnp:Method">>,
		 kind =
...
'15020482145304562784'() ->
    #schema_node{name = 'Type', id = 15020482145304562784, src = <<"include/capnp/schema.capnp:Type">>,
		 kind =
...
'17116997365232503999'() ->
    #schema_node{name = 'Type.interface', id = 17116997365232503999,
		 src = <<"include/capnp/schema.capnp:Type.interface">>,
		 kind =
...
'12410354185295152851'() ->
    #schema_node{name = 'Type.struct', id = 12410354185295152851,
		 src = <<"include/capnp/schema.capnp:Type.struct">>,
		 kind =
		     #struct{dsize = 2, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{name = typeId,
...
'11389172934837766057'() ->
    #schema_node{name = 'Type.enum', id = 11389172934837766057,
		 src = <<"include/capnp/schema.capnp:Type.enum">>,
		 kind =
		     #struct{dsize = 2, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{name = typeId,
...
'9792858745991129751'() ->
    #schema_node{name = 'Type.list', id = 9792858745991129751,
		 src = <<"include/capnp/schema.capnp:Type.list">>,
		 kind =
		     #struct{dsize = 2, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
...
'14853958794117909659'() ->
    #schema_node{name = 'Value', id = 14853958794117909659,
		 src = <<"include/capnp/schema.capnp:Value">>,
		 kind =
		     #struct{dsize = 2, psize = 1, esize = inlineComposite,
			     union_field =
				 #data{type =
...
'17422339044421236034'() ->
    #schema_node{name = 'Annotation', id = 17422339044421236034,
		 src = <<"include/capnp/schema.capnp:Annotation">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{name = id, kind = #data{type = uint64, align = 0, default = <<0, 0, 0, 0, 0, 0, 0, 0>>}},
...
'15102134695616452902'() ->
    #schema_node{name = 'ElementSize', id = 15102134695616452902,
		 src = <<"include/capnp/schema.capnp:ElementSize">>,
		 kind =
		     #enum{values =
...
'13818529054586492878'() ->
    #schema_node{name = 'CodeGeneratorRequest', id = 13818529054586492878,
		 src = <<"include/capnp/schema.capnp:CodeGeneratorRequest">>,
		 kind =
...
'14981803260258615394'() ->
    #schema_node{name = 'CodeGeneratorRequest.RequestedFile', id = 14981803260258615394,
		 src = <<"include/capnp/schema.capnp:CodeGeneratorRequest.RequestedFile">>,
		 kind =
		     #struct{dsize = 1, psize = 2, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{name = id, kind = #data{type = uint64, align = 0, default = <<0, 0, 0, 0, 0, 0, 0, 0>>}},
...
'12560611460656617445'() ->
    #schema_node{name = 'CodeGeneratorRequest.RequestedFile.Import', id = 12560611460656617445,
		 src = <<"include/capnp/schema.capnp:CodeGeneratorRequest.RequestedFile.Import">>,
		 kind =
		     #struct{dsize = 1, psize = 1, esize = inlineComposite, union_field = none,
			     fields =
				 [#field{name = id, kind = #data{type = uint64, align = 0, default = <<0, 0, 0, 0, 0, 0, 0, 0>>}},
